...
users = ('aalonsog', 'fermin', 'frb', 'aarranz', 'amagan', 'fdelavega', 'meth', 'henar', 'knagin', 'tali',
         ...
         'ariokkon', 'cvetan', 'jhyvarinen', 'sami_jylkk', 'jonne.vaisanen', 'loorni', 'tospie', 'glikson', 'jesus.movilla',
         'jesus.perezgonzalez')
...
query = 'project = HELP and status in (Closed, Done, Dismissed) AND component = FIWARE-TECH-HELP and assignee = {}'.format(user)
